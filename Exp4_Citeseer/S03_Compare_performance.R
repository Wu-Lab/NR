...
adj_origi <- as.matrix(read.csv('./Exp5_Citeseer/Data/Network.csv', header = F))
true_membership <- read.csv('./Exp5_Citeseer/Data/Nodes_Labels.csv', header = F)
...
#      main = 'Degree distribution of Citeseer graph',
#      xlab = 'degree',
#      ylab = 'probability',
#      col = '#124E78',
#      type = 'l',
...
# mem.col <- brewer.pal(n = length(unique(true_membership)), 
#                       name = "Spectral")
# svg('./Exp5_Citeseer/Results/Graph.svg')
# plot(g_origi,
...
out_NE_once <-
  as.matrix(read.csv(
    "./Exp4_Citeseer/Data/Network_NE.csv",
    sep = ',',
    encoding = "UTF-8",
    header = F
  ))
...
out_NE_twice <-
  as.matrix(read.csv(
    "./Exp4_Citeseer/Data/Network_NE2.csv",
    sep = ',',
    encoding = "UTF-8",
    header = F
  ))
...
write.csv(score_NMI, './Exp4_Citeseer/Results/score_NMI.csv')
write.csv(score_ARI, './Exp4_Citeseer/Results/score_ARI.csv')
